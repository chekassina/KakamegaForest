...
import { AreaChart, Calendar, ArrowLeft, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-safari-light">
      ...
      <div className="relative h-[60vh] min-h-[400px]">
        <div className="absolute inset-0 z-0 bg-cover bg-center" style={{ backgroundImage: `url(${destination.image})` }}>
        ...
        <div className="absolute top-0 left-0 right-0 z-20 pt-6 px-6 max-w-7xl mx-auto flex justify-between items-center">
          <Link to="/" className="inline-flex items-center text-white hover:text-safari-primary transition-colors">
            <ArrowLeft size={20} className="mr-2" /> Back to Destinations
          </Link>
        </div>
        ...
        <div className="absolute inset-0 z-10 flex flex-col justify-center items-center text-center px-6 pt-20 max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 text-white/90 text-sm md:text-base font-medium uppercase tracking-wider">
              <span className="flex items-center"><Calendar size={18} className="mr-2 text-safari-primary" /> {destination.bestTime}</span>
            </div>
          </motion.div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 md:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-20">
          ...
          <div className="lg:col-span-2">
            <h2 className="text-3xl font-serif text-safari-dark mb-6">Destination Overview</h2>
            <p className="text-safari-dark/80 text-lg leading-relaxed mb-10">
              {destination.longDescription}
            </p>

            <h3 className="text-2xl font-serif text-safari-dark mb-6">Highlights & Attractions</h3>
            ...
            {destination.itinerary && (
              <>
                <h3 className="text-2xl font-serif text-safari-dark mb-6">Sample Itinerary</h3>
                <div className="border-l-2 border-safari-primary/30 pl-6 space-y-8 mb-12">
                  {destination.itinerary.map((day, idx) => (
                    <div key={idx}>
                      ...
                      <p className="text-safari-dark/70 text-sm leading-relaxed">
                        {day.description}
                      </p>
                    </div>
                  ))}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              {destination.includes && (
                <div className="bg-white border text-sm border-gray-100 p-6 rounded-sm shadow-sm md:col-span-1">
                  ...
                  <ul className="space-y-3">
                    {destination.includes.map((item, idx) => (
                      <li key={idx} className="flex items-start text-safari-dark/80">
              ...
              {destination.excludes && (
                <div className="bg-white border text-sm border-gray-100 p-6 rounded-sm shadow-sm md:col-span-1">
                  ...
                  <ul className="space-y-3">
                    {destination.excludes.map((item, idx) => (
                      <li key={idx} className="flex items-start text-safari-dark/80">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-32 bg-white border border-gray-100 rounded-sm shadow-xl shadow-safari-dark/5 p-8">
              ...
              <p className="text-safari-dark/60 text-sm mb-6">Submit an accommodation and booking request to plan your safari to {destination.name}.</p>
              ...
              <form className="space-y-4">
                ...
                <Button className="w-full h-12 mt-4 text-sm font-semibold tracking-wide">Submit Booking Request</Button>
              </form>
